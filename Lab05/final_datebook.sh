...
#Author: Tianyuan Li
#Date: 04/09/2018
#Description: sed commands to modify a databook and save it to a file final_datebook.txt.
...
#Apply changes in exercise 3.
sed -f sed.commands new_datebook.txt > final_datebook.txt
